<%@ Page Language="C#" MasterPageFile="~/Shared/QuickStarts.master" AutoEventWireup="true" Inherits="Customers_CustomersAdvancedView" Title="Customers (advanced) - ObjectContainerDataSource Quickstart" Codebehind="CustomersAdvancedView.aspx.cs" %>

<%@ Register Assembly="Microsoft.Practices.Web.UI.WebControls" Namespace="Microsoft.Practices.Web.UI.WebControls"
    TagPrefix="pp" %>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" runat="Server">
    <p style="color: Gray"><i>This page demonstrates the custom behavior for paging and sorting. With the custom settings, the ObjectContainerDataSource control contains
    a subset of items (a single page). Paging and sorting is performed on the server.</i></p>
    <h2>New Customer</h2>

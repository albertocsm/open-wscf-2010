<%@ Control Language="C#" AutoEventWireup="true" Codebehind="ContactDetail.ascx.cs"
    Inherits="MVPQuickstart.Contacts.Views.ContactDetail" %>
...
<table>
    <tr>
        <td colspan="2">
            ...
            <pp:ObjectContainerDataSource ID="CustomerDataSource" runat="server" DataObjectTypeName="MVPQuickstart.Contacts.BusinessEntities.Customer"
                OnUpdated="CustomerDataSource_Updated" />
            <pp:ObjectContainerDataSource ID="StatesDataSource" runat="server" DataObjectTypeName="MVPQuickstart.Contacts.BusinessEntities.State" />
        </td>
    </tr>
    <tr>
        <td colspan="2">
